...
func TestParseWorkloadSummary(t *testing.T) {
	data := []byte(`{"workload":[
		{"node":1,"zone_name":"System","protocol":"nfs3","username":"alice","system_name":"smbd","job_type":"AVscan[1]","ops":120.5,"bytes_in":1024,"bytes_out":2048,"cpu":50000},
	...
	if ws[0] != (Workload{Node: 1, Zone: "System", Protocol: "nfs3", Username: "alice", SystemName: "smbd", JobType: "AVscan[1]", Ops: 120.5, BytesIn: 1024, BytesOut: 2048, CPUMicros: 50000}) {
